...
public class PhiSinhHoatModel {
    ...
    public PhiSinhHoatModel(String maHoKhau,  float thang1, float thang2, float thang3, float thang4, float thang5, float thang6, float thang7, float thang8, float thang9,float thang10, float thang11,float thang12) {
